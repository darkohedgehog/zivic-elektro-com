    ...
    <div className="relative overflow-hidden py-16 perspective-[1800px] sm:py-24 md:py-32 lg:py-40">
      ...
      <div className="pointer-events-none absolute inset-0 hidden translate-x-10 -rotate-y-50 -mask-linear-50 mask-linear-from-60% mask-linear-to-80% sm:block sm:translate-x-20 md:translate-x-32 lg:translate-x-40">
        <div
          className={cn(
            "absolute inset-0",
            "bg-size-[42px_42px]",
            "bg-[linear-gradient(to_right,var(--color-neutral-800),transparent_1px),linear-gradient(to_bottom,var(--color-neutral-800),transparent_1px)]",
          )}
        />
      ...
      >
        <h1 className="font-manrope text-left text-3xl font-bold tracking-tight text-white text-shadow-lg text-shadow-white/20 sm:text-4xl md:text-5xl lg:text-6xl">
          Get electrified with <br className="hidden sm:block" /> aceternity UI
          Pro
        </h1>
        ...
        <div className="relative mt-8 overflow-hidden rounded-xl border border-neutral-700 bg-neutral-800 p-px sm:mt-10 sm:rounded-2xl md:mt-12 md:rounded-3xl">
          ...
          >
            <div className="absolute -top-px -left-5 z-10 h-20 w-32 bg-[radial-gradient(ellipse_at_top_left,white_0%,transparent_70%)] sm:-left-8 sm:h-28 sm:w-40 md:-left-10 md:h-40 md:w-60"></div>
            <div className="absolute top-0 left-5 h-px w-32 bg-[radial-gradient(ellipse_at_top,white,transparent)] blur-[2px] sm:left-8 sm:w-40 md:left-10 md:w-60"></div>
            <div className="absolute top-0 left-5 h-px w-32 bg-[radial-gradient(ellipse_at_top,white,transparent)] blur-xs sm:left-8 sm:w-40 md:left-10 md:w-60"></div>
          </motion.div>
          <motion.div>
            <div className="absolute -top-px -right-5 z-10 h-20 w-40 bg-[radial-gradient(ellipse_at_top_right,var(--color-yellow-500)_0%,transparent_70%)] sm:-right-8 sm:h-28 sm:w-60 md:-right-10 md:h-40 md:w-80"></div>
            <div className="absolute top-0 right-5 h-px w-32 bg-[radial-gradient(ellipse_at_top,var(--color-yellow-500),transparent)] blur-[2px] sm:right-8 sm:w-40 md:right-10 md:w-60"></div>
            <div className="absolute top-0 right-5 h-px w-32 bg-[radial-gradient(ellipse_at_top,var(--color-yellow-500),transparent)] blur-xs sm:right-8 sm:w-40 md:right-10 md:w-60"></div>
          </motion.div>
  ...
  return (
    <div className="absolute inset-0">
      ...
      {Array.from({ length: GRID_SIZE }).map((_, i) => (
        <div
          key={`v-${i}`}
          className="absolute top-0 bottom-0 w-0.5 bg-linear-to-b from-zinc-800 via-zinc-600 to-zinc-800"
          style={{
      ...
      {Array.from({ length: GRID_SIZE }).map((_, i) => (
        <div
          key={`h-${i}`}
          className="absolute right-0 left-0 h-0.5 bg-linear-to-r from-zinc-800 via-zinc-600 to-zinc-800"
          style={{
...
const Bulb = ({
  ...
  return (
    <div className="relative">
      ...
      <div className="size-6 rounded-full bg-linear-to-b from-zinc-300 via-zinc-500 to-zinc-700 p-px shadow-[inset_0_1px_1px_rgba(255,255,255,0.4),inset_0_-1px_1px_rgba(0,0,0,0.3),0_2px_4px_rgba(0,0,0,0.5)] sm:size-8 sm:p-0.5 md:size-10">
        {/* Steel frame - inner ring with brushed metal effect */}
        <div className="size-full rounded-full bg-linear-to-b from-zinc-600 via-zinc-400 to-zinc-600 p-px shadow-[inset_0_2px_3px_rgba(255,255,255,0.2),inset_0_-2px_3px_rgba(0,0,0,0.3)] sm:p-0.5">
          {/* The bulb itself */}
          <motion.div
          ...
          >
            {/* Outer glow layer */}
            <motion.div
              className="absolute inset-0 rounded-full bg-linear-to-br from-yellow-400/20 to-orange-500/20 blur-sm"
            ...
            {/* Middle warm glow */}
            <motion.div
              className="absolute inset-0 m-auto h-[85%] w-[85%] rounded-full bg-linear-to-br from-orange-400 to-yellow-500 blur-[2px]"
            ...
            {/* Inner bright core */}
            <motion.div
              className="absolute inset-0 m-auto h-[70%] w-[70%] rounded-full bg-linear-to-br from-yellow-200 to-yellow-400 blur-[1px]"
